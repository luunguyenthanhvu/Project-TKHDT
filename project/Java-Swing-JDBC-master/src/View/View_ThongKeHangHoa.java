...
public class View_ThongKeHangHoa extends AThongKe{
	JPanel p1,p2;
	JLabel l1,l2,l3,l4,l5,l6,lh;
	JButton ok;

	public View_ThongKeHangHoa(String s, ArrayList<QLHHModel> h) {
		super(s, h);
		...
		ActionListener ac = new Controller_ThongKe(this);
